...
def main():
    ...
    for episode in range(EPISODE):
        ...
        #########################################################
        triplet_num=random.randint(4,5)
        ...
        if (episode + 1) % 100 == 0:
            ...
            for num_train_wc in range(4,6):
                for num_train_fault_type in range(1,5):
                    ...
                    accuracy8=accuracy8+test_accuracy
            print(" test accuracy:", accuracy8/8.0)
            if accuracy8 >= last_accuracy:
                # save networks
