...
faulttype = 'gearboxtype6'
root_path = '../Test_Data/Single_fault/'
test_result_sim = './test_result/similar_score_true/'
test_result_acc = './test_result/acc_callback/'
...
def main():
    ...
    print("Testing...leftaxlebox type9 ")
    acc_back = []
    for episode in range(10):
        ...
        with torch.no_grad():
            for i in range(TEST_EPISODE):
                ...
                metatest_character_folders1 = [root_path + 'gearbox/test/health',
                                               root_path + 'gearbox/test/anomaly/anomalyTYPE6']  #
                metatrain_character_folders1 = [root_path + 'gearbox/train/health',
                                                root_path + 'gearbox/train/anomaly']
    ...
    np.savetxt(test_result_acc + faulttype + '啊啊啊_acc_back.csv', np.array(acc_back), fmt='%.4f', delimiter=',')
