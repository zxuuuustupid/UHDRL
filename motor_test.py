...
def main():
    ...
    # Step 3: build graph
    accuracy_list = [[0] * 9 for _ in range(4)]
    recall_list = [[0] * 9 for _ in range(4)]
    std_list = [[0] * 9 for _ in range(4)]
        ...
        for num_wc in range(1, 9 + 1):
            ...
            for ten_epoches in range(1, 11):
                ...
                for i in range(TEST_EPISODE):
                    num_wc_mixed=random.randint(1,9)
                    ...
                    metatrain_character_folders1 = [f'../CWT3-1000/motor/train/health/WC{num_wc_mixed}',
...
if __name__ == '__main__':
    ...
    # 构建目标文件路径
    file_path_std = os.path.join('test_result', 'motor', 'motor_std.csv')
    file_path_acc = os.path.join('test_result', 'motor', 'motor_acc_mixed.csv')
    file_path_recall = os.path.join('test_result', 'motor', 'motor_recall_mixed.csv')
    # 保存为 CSV 文件
