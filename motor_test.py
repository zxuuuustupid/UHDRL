...
if __name__ == '__main__':
    ...
    # 构建目标文件路径
    file_path_acc = os.path.join('test_result', 'motor', 'motor_acc_mixed_notriloss.csv')
    file_path_recall = os.path.join('test_result', 'motor', 'motor_recall_mixed_notriloss.csv')
    # 保存为 CSV 文件
