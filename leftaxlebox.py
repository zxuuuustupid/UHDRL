...
def main():
    ...
    for episode in range(EPISODE):
        ...
        # health_character_folders_1 = [f'../CWT-1000/leftaxlebox/train/health/WC{triplet_num}',
        #                               '../CWT-1000/leftaxlebox/train/health']
        health_character_folders_1 = [f'../CWT3-1000/leftaxlebox/train/health/WC{triplet_num}',
                                      '../CWT3-1000/leftaxlebox/train/health']
        # arch_character_folders_1 = [f'../CWT-1000/leftaxlebox/train/health/WC{triplet_num}',
        #                             '../CWT-1000/leftaxlebox/train/health']
        arch_character_folders_1 = [f'../CWT3-1000/leftaxlebox/train/health/WC{triplet_num}',
                                    '../CWT3-1000/leftaxlebox/train/health']
        random_folder = random.choice([f.path for f in os.scandir('../CWT3-1000/leftaxlebox/train/anomaly') if f.is_dir()])
        ...
        metatrain_character_folders_1 = [f'../CWT3-1000/leftaxlebox/train/health/WC{num_wc}',
                                         '../CWT3-1000/leftaxlebox/train/anomaly']
        # metatrain_character_folders_1 = [f'../CWT-1000/leftaxlebox/train/health/WC{num_wc}',
        ...
        if (episode + 1) % 100 == 0:
            ...
            for i in range(TEST_EPISODE):
                ...
                degrees = random.choice([0, 90, 180, 270])
                metatest_character_folders1 = [f'../CWT3-1000/leftaxlebox/train/health/WC{num_train_wc}',
                                               f'../CWT3-1000/leftaxlebox/test/LA{num_train_fault_type}/anomaly/WC{num_train_wc}']
                metatrain_character_folders1 = [f'../CWT3-1000/leftaxlebox/train/health/WC{num_train_wc}',
                                                f'../CWT3-1000/leftaxlebox/train/anomaly']
                # metatest_character_folders1 = [f'../CWT-1000/leftaxlebox/train/health/WC{num_train_wc}',
                #                                f'../CWT-1000/leftaxlebox/test/G{num_train_fault_type}/anomaly/WC{num_train_wc}']
                # metatrain_character_folders1 = [f'../CWT-1000/leftaxlebox/train/health/WC{num_train_wc}',
                #                                 f'../CWT-1000/leftaxlebox/train/anomaly']
