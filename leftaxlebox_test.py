        ...
        for num_wc in range(1, 9 + 1):
            ...
            for ten_epoches in range(1, 11):
                ...
                for i in range(TEST_EPISODE):
                    ...
                    # metatest_character_folders1 = [f'../CWT-1000/leftaxlebox/test/health/WC{num_wc}',
                    #                                f'../CWT-1000/leftaxlebox/test/LA{num_fault_type}/anomaly/WC{num_wc}']
                    # metatrain_character_folders1 = [f'../CWT-1000/leftaxlebox/train/health/WC{num_wc}',
                    ...
                    metatrain_character_folders1 = [f'../CWT3-1000/leftaxlebox/train/health/WC{num_wc_mixed}',
            ...
            print("FaultType:LA", str(num_fault_type).ljust(2),
