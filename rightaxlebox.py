...
def main():
    ...
    for episode in range(EPISODE):
        ...
        metatrain_character_folders_1 = ['../CWT-1000/rightaxlebox/train/health',
                                         '../CWT-1000/rightaxlebox/train/anomaly']
        ...
        if (episode + 1) % 100 == 0:
            ...
            print("Testing...1-1,rightaxlebox type11317",end='')
            total_rewards_1_1 = 0
            for i in range(TEST_EPISODE):
                degrees = random.choice([0, 90, 180, 270])
                metatest_character_folders1 = ['../CWT-1000/rightaxlebox/test/health',
                                               '../CWT-1000/rightaxlebox/test/anomaly/anomalyTYPE11317']
                # '../CWT-1000/rightaxlebox/test/anomaly/anomalyTYPE13']
                # '../CWT-1000/rightaxlebox/test/anomaly/anomalyTYPE14']
                metatrain_character_folders1 = ['../CWT-1000/rightaxlebox/train/health',
                                                '../CWT-1000/rightaxlebox/train/anomaly']
            ...
            #
            # print("Testing...1-2,lefaxlebox type14", end='')
            # total_rewards_1_2 = 0
            # for i in range(TEST_EPISODE):
            #     degrees = random.choice([0, 90, 180, 270])
            #     metatest_character_folders1 = ['../CWT-1000/rightaxlebox/test/health',
            ...
            # print("Testing...1-3,lefaxlebox type15", end='')
            # total_rewards_1_3 = 0
            # for i in range(TEST_EPISODE):
            #     degrees = random.choice([0, 90, 180, 270])
            #     metatest_character_folders1 = ['../CWT-1000/rightaxlebox/test/health',
            #                                    '../CWT-1000/rightaxlebox/test/anomaly/anomalyTYPE15']
            #     # '../CWT-1000/rightaxlebox/test/anomaly/anomalyTYPE13']
            #     # '../CWT-1000/rightaxlebox/test/anomaly/anomalyTYPE14']
            #     metatrain_character_folders1 = ['../CWT-1000/rightaxlebox/train/health',
            #                                     '../CWT-1000/rightaxlebox/train/anomaly']
            ...
            ###总精度
            test_accuracy = test_accuracy_1_1
            # + test_accuracy_1_2 + test_accuracy_1_3
...
if __name__ == '__main__':
    ...
    np.savetxt(train_result + 'Rightaxlebox_train_loss_1.csv', loos_result_1_cpu, fmt='%.8f', delimiter=',')
