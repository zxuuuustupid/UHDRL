...
# 进行t-SNE降维
X_norm1 = SNE.sen_huatu(X1, 10)
X_norm2 = SNE.sen_huatu(X2, 10)
X_norm3 = SNE.sen_huatu(X3, 10)
X_norm4 = SNE.sen_huatu(X4, 10)
X_norm5 = SNE.sen_huatu(X5, 10)
X_norm6 = SNE.sen_huatu(X6, 10)
X_norm7 = SNE.sen_huatu(X7, 10)
X_norm8 = SNE.sen_huatu(X8, 10)
X_norm9 = SNE.sen_huatu(X9, 10)
X_norm10 = SNE.sen_huatu(X10, 10)
