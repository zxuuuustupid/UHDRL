...
# 读取十个CSV文件
df1 = pd.read_csv('train_result/output_features/leftaxlebox_anomaly.csv', header=None)
df2 = pd.read_csv('train_result/output_features/leftaxlebox_arch.csv', header=None)
df3 = pd.read_csv('train_result/output_features/leftaxlebox_health.csv', header=None)
d3 = pd.read_csv('train_result/output_features/leftaxlebox_health3.csv', header=None)
d4 = pd.read_csv('train_result/output_features/leftaxlebox_health4.csv', header=None)
d5 = pd.read_csv('train_result/output_features/leftaxlebox_health5.csv', header=None)
d6 = pd.read_csv('train_result/output_features/leftaxlebox_health6.csv', header=None)
d7 = pd.read_csv('train_result/output_features/leftaxlebox_health7.csv', header=None)
d8 = pd.read_csv('train_result/output_features/leftaxlebox_health8.csv', header=None)
d9 = pd.read_csv('train_result/output_features/leftaxlebox_health9.csv', header=None)
...
#
# 将所有数据保存到一个CSV文件
all_data.to_csv('train_result/output_features/all_norm_data_motor.csv', index=False)
